...
const ModelWindow = () => {
  ...
  return (
    <>
      <h1 className='text-primary-100 font-Itim text-2xl mx-auto'>{heading}</h1>
      <Suspense fallback={<div className='flex justify-center items-center w-4/5 h-[55%] my-0 mx-auto text-primary-100'>Loading Model</div>}>
