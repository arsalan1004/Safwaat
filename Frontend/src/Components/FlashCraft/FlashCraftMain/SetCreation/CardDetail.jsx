  ...
  return (
    <div className='w-full shadow-[0_4px_4px_rgba(0,0,0,.25)] rounded-xl h-40 
        ...
        <div className='mt-2 mx-10 w-11/12'>
            <input className='border-b-2 border-secondary w-full outline-none pb-1.5 bg-primary-100
                    mb-2 text-secondary text-[13px]' type='text'></input>
            <br />
        ...
        <div className='mt-1 mx-10 w-11/12'>
            <input className='border-b-2 border-secondary w-full outline-none pb-1.5 bg-primary-100
                    mb-2 text-secondary text-[13px]' type='text'></input>
            <br />
            <span className='font-Inter text-base font-bold text-secondary'>Description</span>
        </div>
    </div>
  )
}
