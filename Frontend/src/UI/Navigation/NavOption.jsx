...
function NavOption(props) {
  return (
    <div className={`group flex items-center mb-3 pl-4 py-2 rounded-lg
        ...
        <h2 className={`py-1 truncate font-Montserrat h-full w-full font-bold tracking-widest text-sm group-hover:text-[#24B6FB]  
